...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'iPapkornfiles')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "True")), True)
PM_IMDB = environ.get('PM_IMDB', "True")
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "`{file_name}`\n\n⚠️ 𝐍𝐨𝐭𝐞: This message will be Auto-deleted after 5 minutes to avoid copyright issues.   \n 𝙁𝙤𝙧𝙬𝙖𝙧𝙙 𝙩𝙤 𝙎𝙖𝙫𝙚𝙙 𝙈𝙚𝙨𝙨𝙖𝙜𝙚𝙨⚠️")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "[ @iPapkornFiles ]")
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>Query: {query}</b> \n‌IMDb Data:\n\n🏷 Title: <a href={url}>{title}</a> \n\n <a href=https://youtube.com/shorts/0y7VZMf4990?feature=share>Hᴏᴡ Tᴏ Dᴏᴡɴʟᴏᴀᴅ</a> \n\n <a href=https://youtube.com/shorts/0y7VZMf4990?feature=share>Hᴏᴡ Tᴏ Dᴏᴡɴʟᴏᴀᴅ</a>")
